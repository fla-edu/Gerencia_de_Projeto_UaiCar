                ...
                <div class="right-sidebar">
                    <div class="slimscrollright">
                        <div class="rpanel-title">Personalização <span><i class="ti-close right-side-toggle"></i></span> </div>
                        <div class="r-panel-body">
                            <ul id="themecolors" class="m-t-20">
                                ...
                                <li class="d-block m-t-30"><b>Menu escuro</b></li>
    ...
    <!-- <script src="../../assets/plugins/fselect/fSelect.js"></script> -->
    <script src="../../assets/plugins/toast-master/js/jquery.toast.js"></script>
